var lightTheme = {
  ...
  '--disabled-text-color':
    'rgba(50, 51, 56, var(--disabled-component-opacity))',
  ...
  '--ajax-spinner-gif-path':
    'url(https://cdn.monday.com/images/ajax_spinner.gif)',
  '--scrollbar-color': 'var(--color-wolf_gray)',
  '--monday-loader-gif-path':
    'url(https://cdn.monday.com/images/loader/loader.gif)',
  ...
  '--ai-hover-color':
    'linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), linear-gradient(264.27deg, #0073ea 0%, #0f80ed 26.48%, #1e8df0 52.75%, #45aff8 83.22%, #66ccff 100%)',
  '--ai-color-secondary': 'rgba(204, 229, 255, 1)',
  '--ai-disabled':
    'linear-gradient(0deg, rgba(128, 128, 128, 0.28), rgba(128, 128, 128, 0.28)), linear-gradient( 235.8deg, rgba(81, 213, 255, 0.79) 19.96%, rgba(75, 206, 253, 0.79) 22.58%, rgba(43, 167, 245, 0.79) 39.79%, rgba(19, 138, 239, 0.79) 71.58%, rgba(0, 115, 234, 0.79) 91.77%, rgba(5, 121, 235, 0.79) 91.77% )',
};
